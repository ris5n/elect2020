...
remote = True
input_file = '.\data\election_2020\mi_president.json'
output_file = '.\\results\election_2020\mi_president_computed.csv'
rest_url = 'https://static01.nyt.com/elections-assets/2020/data/api/2020-11-03/race-page/michigan/president.json'
